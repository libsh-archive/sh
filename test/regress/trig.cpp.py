...
def insert_into5(test):
    ...
    test.add_test(atan2_test((0, 1.0, 1.0), (1.0, 1.0, 2.0), [], 0.003))
    test.add_test(atan2_test((0, 1.5, 3.0), (0.5, 1.0, 2.0), [], 0.003))
    ...
    test.add_test(atan2_test((1.0, 0.0), (-math.pi/2.0, 1.0), [], 0.003))
