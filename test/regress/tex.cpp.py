...
test.add_texture(shtest.GenTexture("NoMIPFilter<Texture2D<Color3fub> >",
    "FracUByte", "FUBYTE", 3, (16, 16), "clamp_tex", "(i - 2 * j + 4 * elem) / 2"))
test.clear_call()
...
test.add_texture(shtest.GenTexture("NoMIPFilter<Texture2D<Color4fui> >",
    "FracUInt", "FUINT", 4, (8, 8), "frac_uint2d_tex", "(i + 3 * j + 7 * elem) / 100.0"))
test.clear_call()
...
test.add_texture(shtest.GenTexture("NoMIPFilter<Texture2D<Color3fb> >",
    "FracByte", "FBYTE", 3, (8, 8), "frac_byte2d_tex", "(-i + j + elem - 1) / 10.0"))
test.clear_call()
...
test.add_texture(shtest.GenTexture("NoMIPFilter<Texture2D<Color3h> >",
    "Half", "HALF", 3, (16, 16), "half2d_tex", "100 * (i - 8) + 10 * (j - 8) + elem"))
test.clear_call()
...
test.add_texture(shtest.GenTexture("NoMIPFilter<TextureRect<Color3h> >",
    "Half", "HALF", 3, (16, 16), "half_rect_tex", "100 * (i - 8) + 10 * (j - 8) + elem"))
test.clear_call()
...
test.add_texture(shtest.GenTexture("ArrayRect<Color3f>",
    "float", "FLOAT", 3, (16, 16), "float_array", "i + 3 * j"))
test.clear_call()
