...
test.add_test(ge((0.0, 1.0, -0.5, 0.1), (0.0, 0.0, 1.0, -1.0)))

test.add_test(ge(0.0, (-1.0, 0.0, 1.0)))
test.add_test(ge(2.0, (-1.0, 0.0, 1.0)))
test.add_test(ge((-1.0, 0.0, 1.0), -2.0))
test.add_test(ge((-1.0, 0.0, 1.0), 0.0))
