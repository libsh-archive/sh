...
template<int N2>
ShVector<N2, Binding, T, true>
ShVector<N, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShVector<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShVector<N2, Binding, T, true>
ShVector<1, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShVector<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShVector<N2, Binding, T, true>
ShVector<2, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShVector<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShVector<N2, Binding, T, true>
ShVector<3, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShVector<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShVector<N2, Binding, T, true>
ShVector<4, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShVector<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
