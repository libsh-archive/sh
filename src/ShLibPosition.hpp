...
operator|(const ShMatrix<4, 4, B1, T>& m, const ShAttrib<3, B2, T, SH_POSITION, S1>& v)
{
...
operator|(const ShMatrix<3, 3, B1, T>& m, const ShAttrib<2, B2, T, SH_POSITION, S1>& v)
{
...
template<ShBindingType B1, ShBindingType B2, typename T, bool S1>
ShAttrib<1, SH_TEMP, T, SH_POSITION, false>
operator|(const ShMatrix<2, 2, B1, T>& m, const ShAttrib<1, B2, T, SH_POSITION, S1>& v)
{
