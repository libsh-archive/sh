...
template<int N2>
ShPoint<N2, Binding, T, true>
ShPoint<N, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPoint<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPoint<N2, Binding, T, true>
ShPoint<1, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPoint<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPoint<N2, Binding, T, true>
ShPoint<2, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPoint<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPoint<N2, Binding, T, true>
ShPoint<3, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPoint<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPoint<N2, Binding, T, true>
ShPoint<4, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPoint<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
