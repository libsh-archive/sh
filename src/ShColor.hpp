...
typedef ShAttrib<1, SH_INPUT, ShInterval<double> , SH_COLOR> ShInputColor1i_d;
typedef ShAttrib<1, SH_OUTPUT, ShInterval<double> , SH_COLOR> ShOutputColor1i_d;
typedef ShAttrib<1, SH_INOUT, ShInterval<double> , SH_COLOR> ShInOutColor1i_d;
typedef ShAttrib<1, SH_TEMP, ShInterval<double> , SH_COLOR> ShColor1i_d;
typedef ShAttrib<1, SH_CONST, ShInterval<double> , SH_COLOR> ShConstColor1i_d;
typedef ShAttrib<2, SH_INPUT, ShInterval<double> , SH_COLOR> ShInputColor2i_d;
typedef ShAttrib<2, SH_OUTPUT, ShInterval<double> , SH_COLOR> ShOutputColor2i_d;
typedef ShAttrib<2, SH_INOUT, ShInterval<double> , SH_COLOR> ShInOutColor2i_d;
typedef ShAttrib<2, SH_TEMP, ShInterval<double> , SH_COLOR> ShColor2i_d;
typedef ShAttrib<2, SH_CONST, ShInterval<double> , SH_COLOR> ShConstColor2i_d;
typedef ShAttrib<3, SH_INPUT, ShInterval<double> , SH_COLOR> ShInputColor3i_d;
typedef ShAttrib<3, SH_OUTPUT, ShInterval<double> , SH_COLOR> ShOutputColor3i_d;
typedef ShAttrib<3, SH_INOUT, ShInterval<double> , SH_COLOR> ShInOutColor3i_d;
typedef ShAttrib<3, SH_TEMP, ShInterval<double> , SH_COLOR> ShColor3i_d;
typedef ShAttrib<3, SH_CONST, ShInterval<double> , SH_COLOR> ShConstColor3i_d;
typedef ShAttrib<4, SH_INPUT, ShInterval<double> , SH_COLOR> ShInputColor4i_d;
typedef ShAttrib<4, SH_OUTPUT, ShInterval<double> , SH_COLOR> ShOutputColor4i_d;
typedef ShAttrib<4, SH_INOUT, ShInterval<double> , SH_COLOR> ShInOutColor4i_d;
typedef ShAttrib<4, SH_TEMP, ShInterval<double> , SH_COLOR> ShColor4i_d;
typedef ShAttrib<4, SH_CONST, ShInterval<double> , SH_COLOR> ShConstColor4i_d;
...
typedef ShAttrib<1, SH_INPUT, ShAffine<double> , SH_COLOR> ShInputColor1a_d;
typedef ShAttrib<1, SH_OUTPUT, ShAffine<double> , SH_COLOR> ShOutputColor1a_d;
typedef ShAttrib<1, SH_INOUT, ShAffine<double> , SH_COLOR> ShInOutColor1a_d;
typedef ShAttrib<1, SH_TEMP, ShAffine<double> , SH_COLOR> ShColor1a_d;
typedef ShAttrib<1, SH_CONST, ShAffine<double> , SH_COLOR> ShConstColor1a_d;
typedef ShAttrib<2, SH_INPUT, ShAffine<double> , SH_COLOR> ShInputColor2a_d;
typedef ShAttrib<2, SH_OUTPUT, ShAffine<double> , SH_COLOR> ShOutputColor2a_d;
typedef ShAttrib<2, SH_INOUT, ShAffine<double> , SH_COLOR> ShInOutColor2a_d;
typedef ShAttrib<2, SH_TEMP, ShAffine<double> , SH_COLOR> ShColor2a_d;
typedef ShAttrib<2, SH_CONST, ShAffine<double> , SH_COLOR> ShConstColor2a_d;
typedef ShAttrib<3, SH_INPUT, ShAffine<double> , SH_COLOR> ShInputColor3a_d;
typedef ShAttrib<3, SH_OUTPUT, ShAffine<double> , SH_COLOR> ShOutputColor3a_d;
typedef ShAttrib<3, SH_INOUT, ShAffine<double> , SH_COLOR> ShInOutColor3a_d;
typedef ShAttrib<3, SH_TEMP, ShAffine<double> , SH_COLOR> ShColor3a_d;
typedef ShAttrib<3, SH_CONST, ShAffine<double> , SH_COLOR> ShConstColor3a_d;
typedef ShAttrib<4, SH_INPUT, ShAffine<double> , SH_COLOR> ShInputColor4a_d;
typedef ShAttrib<4, SH_OUTPUT, ShAffine<double> , SH_COLOR> ShOutputColor4a_d;
typedef ShAttrib<4, SH_INOUT, ShAffine<double> , SH_COLOR> ShInOutColor4a_d;
typedef ShAttrib<4, SH_TEMP, ShAffine<double> , SH_COLOR> ShColor4a_d;
typedef ShAttrib<4, SH_CONST, ShAffine<double> , SH_COLOR> ShConstColor4a_d;


typedef ShAttrib<1, SH_INPUT, ShAffine<float> , SH_COLOR> ShInputColor1a_f;
typedef ShAttrib<1, SH_OUTPUT, ShAffine<float> , SH_COLOR> ShOutputColor1a_f;
typedef ShAttrib<1, SH_INOUT, ShAffine<float> , SH_COLOR> ShInOutColor1a_f;
typedef ShAttrib<1, SH_TEMP, ShAffine<float> , SH_COLOR> ShColor1a_f;
typedef ShAttrib<1, SH_CONST, ShAffine<float> , SH_COLOR> ShConstColor1a_f;
typedef ShAttrib<2, SH_INPUT, ShAffine<float> , SH_COLOR> ShInputColor2a_f;
typedef ShAttrib<2, SH_OUTPUT, ShAffine<float> , SH_COLOR> ShOutputColor2a_f;
typedef ShAttrib<2, SH_INOUT, ShAffine<float> , SH_COLOR> ShInOutColor2a_f;
typedef ShAttrib<2, SH_TEMP, ShAffine<float> , SH_COLOR> ShColor2a_f;
typedef ShAttrib<2, SH_CONST, ShAffine<float> , SH_COLOR> ShConstColor2a_f;
typedef ShAttrib<3, SH_INPUT, ShAffine<float> , SH_COLOR> ShInputColor3a_f;
typedef ShAttrib<3, SH_OUTPUT, ShAffine<float> , SH_COLOR> ShOutputColor3a_f;
typedef ShAttrib<3, SH_INOUT, ShAffine<float> , SH_COLOR> ShInOutColor3a_f;
typedef ShAttrib<3, SH_TEMP, ShAffine<float> , SH_COLOR> ShColor3a_f;
typedef ShAttrib<3, SH_CONST, ShAffine<float> , SH_COLOR> ShConstColor3a_f;
typedef ShAttrib<4, SH_INPUT, ShAffine<float> , SH_COLOR> ShInputColor4a_f;
typedef ShAttrib<4, SH_OUTPUT, ShAffine<float> , SH_COLOR> ShOutputColor4a_f;
typedef ShAttrib<4, SH_INOUT, ShAffine<float> , SH_COLOR> ShInOutColor4a_f;
typedef ShAttrib<4, SH_TEMP, ShAffine<float> , SH_COLOR> ShColor4a_f;
typedef ShAttrib<4, SH_CONST, ShAffine<float> , SH_COLOR> ShConstColor4a_f;
...
typedef ShAttrib<1, SH_INPUT, ShInterval<float> , SH_COLOR> ShInputColor1i_f;
typedef ShAttrib<1, SH_OUTPUT, ShInterval<float> , SH_COLOR> ShOutputColor1i_f;
typedef ShAttrib<1, SH_INOUT, ShInterval<float> , SH_COLOR> ShInOutColor1i_f;
typedef ShAttrib<1, SH_TEMP, ShInterval<float> , SH_COLOR> ShColor1i_f;
typedef ShAttrib<1, SH_CONST, ShInterval<float> , SH_COLOR> ShConstColor1i_f;
typedef ShAttrib<2, SH_INPUT, ShInterval<float> , SH_COLOR> ShInputColor2i_f;
typedef ShAttrib<2, SH_OUTPUT, ShInterval<float> , SH_COLOR> ShOutputColor2i_f;
typedef ShAttrib<2, SH_INOUT, ShInterval<float> , SH_COLOR> ShInOutColor2i_f;
typedef ShAttrib<2, SH_TEMP, ShInterval<float> , SH_COLOR> ShColor2i_f;
typedef ShAttrib<2, SH_CONST, ShInterval<float> , SH_COLOR> ShConstColor2i_f;
typedef ShAttrib<3, SH_INPUT, ShInterval<float> , SH_COLOR> ShInputColor3i_f;
typedef ShAttrib<3, SH_OUTPUT, ShInterval<float> , SH_COLOR> ShOutputColor3i_f;
typedef ShAttrib<3, SH_INOUT, ShInterval<float> , SH_COLOR> ShInOutColor3i_f;
typedef ShAttrib<3, SH_TEMP, ShInterval<float> , SH_COLOR> ShColor3i_f;
typedef ShAttrib<3, SH_CONST, ShInterval<float> , SH_COLOR> ShConstColor3i_f;
typedef ShAttrib<4, SH_INPUT, ShInterval<float> , SH_COLOR> ShInputColor4i_f;
typedef ShAttrib<4, SH_OUTPUT, ShInterval<float> , SH_COLOR> ShOutputColor4i_f;
typedef ShAttrib<4, SH_INOUT, ShInterval<float> , SH_COLOR> ShInOutColor4i_f;
typedef ShAttrib<4, SH_TEMP, ShInterval<float> , SH_COLOR> ShColor4i_f;
typedef ShAttrib<4, SH_CONST, ShInterval<float> , SH_COLOR> ShConstColor4i_f;
