...
ShMatrix<Rows, Cols, Kind, T>::subMatrix(int rowToRemove,int columnToRemove) const
{
...
template<int Rows, int Cols, int Kind, typename T>
void ShMatrix<Rows, Cols, Kind, T>::name(const std::string& name)
{
...
template<int Rows, int Cols, int Kind, typename T>
std::string ShMatrix<Rows, Cols, Kind, T>::name() const
{
...
template<int Rows, int Cols, int Kind, typename T>
void ShMatrix<Rows, Cols, Kind, T>::range(T low, T high)
{
  for (int i = 0; i < Rows; i++) m_data[i].range(low, high);
}

template<int Rows, int Cols, int Kind, typename T>
void ShMatrix<Rows, Cols, Kind, T>::internal(bool setting)
{
