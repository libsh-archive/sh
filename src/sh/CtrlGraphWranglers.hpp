...
//
SH_DLLEXPORT
void structReplaceExits(StructuralNode* node, 
                        CtrlGraphNode* head, CtrlGraphNode* tail); 
...
SH_DLLEXPORT
void structReplaceEntries(StructuralNode* node, 
                          CtrlGraphNode* head, CtrlGraphNode* tail); 
 ...
 * destination. 
 */
/* @todo Need to decide how to give empty node an owner 
 * This isn't used anywhere now anyway */ 
#if 0
SH_DLLEXPORT
