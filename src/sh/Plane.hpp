...
typedef Attrib<1, SH_INPUT, Affine<float> , SH_PLANE> InputPlane1a_f;
typedef Attrib<1, SH_OUTPUT, Affine<float> , SH_PLANE> OutputPlane1a_f;
typedef Attrib<1, SH_INOUT, Affine<float> , SH_PLANE> InOutPlane1a_f;
typedef Attrib<1, SH_TEMP, Affine<float> , SH_PLANE>  Plane1a_f;
typedef Attrib<1, SH_CONST, Affine<float> , SH_PLANE> ConstPlane1a_f;
typedef Attrib<2, SH_INPUT, Affine<float> , SH_PLANE> InputPlane2a_f;
typedef Attrib<2, SH_OUTPUT, Affine<float> , SH_PLANE> OutputPlane2a_f;
typedef Attrib<2, SH_INOUT, Affine<float> , SH_PLANE> InOutPlane2a_f;
typedef Attrib<2, SH_TEMP, Affine<float> , SH_PLANE>  Plane2a_f;
typedef Attrib<2, SH_CONST, Affine<float> , SH_PLANE> ConstPlane2a_f;
typedef Attrib<3, SH_INPUT, Affine<float> , SH_PLANE> InputPlane3a_f;
typedef Attrib<3, SH_OUTPUT, Affine<float> , SH_PLANE> OutputPlane3a_f;
typedef Attrib<3, SH_INOUT, Affine<float> , SH_PLANE> InOutPlane3a_f;
typedef Attrib<3, SH_TEMP, Affine<float> , SH_PLANE>  Plane3a_f;
typedef Attrib<3, SH_CONST, Affine<float> , SH_PLANE> ConstPlane3a_f;
typedef Attrib<4, SH_INPUT, Affine<float> , SH_PLANE> InputPlane4a_f;
typedef Attrib<4, SH_OUTPUT, Affine<float> , SH_PLANE> OutputPlane4a_f;
typedef Attrib<4, SH_INOUT, Affine<float> , SH_PLANE> InOutPlane4a_f;
typedef Attrib<4, SH_TEMP, Affine<float> , SH_PLANE>  Plane4a_f;
typedef Attrib<4, SH_CONST, Affine<float> , SH_PLANE> ConstPlane4a_f;
...
typedef Attrib<1, SH_INPUT, Interval<double> , SH_PLANE> InputPlane1i_d;
typedef Attrib<1, SH_OUTPUT, Interval<double> , SH_PLANE> OutputPlane1i_d;
typedef Attrib<1, SH_INOUT, Interval<double> , SH_PLANE> InOutPlane1i_d;
typedef Attrib<1, SH_TEMP, Interval<double> , SH_PLANE>  Plane1i_d;
typedef Attrib<1, SH_CONST, Interval<double> , SH_PLANE> ConstPlane1i_d;
typedef Attrib<2, SH_INPUT, Interval<double> , SH_PLANE> InputPlane2i_d;
typedef Attrib<2, SH_OUTPUT, Interval<double> , SH_PLANE> OutputPlane2i_d;
typedef Attrib<2, SH_INOUT, Interval<double> , SH_PLANE> InOutPlane2i_d;
typedef Attrib<2, SH_TEMP, Interval<double> , SH_PLANE>  Plane2i_d;
typedef Attrib<2, SH_CONST, Interval<double> , SH_PLANE> ConstPlane2i_d;
typedef Attrib<3, SH_INPUT, Interval<double> , SH_PLANE> InputPlane3i_d;
typedef Attrib<3, SH_OUTPUT, Interval<double> , SH_PLANE> OutputPlane3i_d;
typedef Attrib<3, SH_INOUT, Interval<double> , SH_PLANE> InOutPlane3i_d;
typedef Attrib<3, SH_TEMP, Interval<double> , SH_PLANE>  Plane3i_d;
typedef Attrib<3, SH_CONST, Interval<double> , SH_PLANE> ConstPlane3i_d;
typedef Attrib<4, SH_INPUT, Interval<double> , SH_PLANE> InputPlane4i_d;
typedef Attrib<4, SH_OUTPUT, Interval<double> , SH_PLANE> OutputPlane4i_d;
typedef Attrib<4, SH_INOUT, Interval<double> , SH_PLANE> InOutPlane4i_d;
typedef Attrib<4, SH_TEMP, Interval<double> , SH_PLANE>  Plane4i_d;
typedef Attrib<4, SH_CONST, Interval<double> , SH_PLANE> ConstPlane4i_d;
...
typedef Attrib<1, SH_INPUT, Affine<double> , SH_PLANE> InputPlane1a_d;
typedef Attrib<1, SH_OUTPUT, Affine<double> , SH_PLANE> OutputPlane1a_d;
typedef Attrib<1, SH_INOUT, Affine<double> , SH_PLANE> InOutPlane1a_d;
typedef Attrib<1, SH_TEMP, Affine<double> , SH_PLANE>  Plane1a_d;
typedef Attrib<1, SH_CONST, Affine<double> , SH_PLANE> ConstPlane1a_d;
typedef Attrib<2, SH_INPUT, Affine<double> , SH_PLANE> InputPlane2a_d;
typedef Attrib<2, SH_OUTPUT, Affine<double> , SH_PLANE> OutputPlane2a_d;
typedef Attrib<2, SH_INOUT, Affine<double> , SH_PLANE> InOutPlane2a_d;
typedef Attrib<2, SH_TEMP, Affine<double> , SH_PLANE>  Plane2a_d;
typedef Attrib<2, SH_CONST, Affine<double> , SH_PLANE> ConstPlane2a_d;
typedef Attrib<3, SH_INPUT, Affine<double> , SH_PLANE> InputPlane3a_d;
typedef Attrib<3, SH_OUTPUT, Affine<double> , SH_PLANE> OutputPlane3a_d;
typedef Attrib<3, SH_INOUT, Affine<double> , SH_PLANE> InOutPlane3a_d;
typedef Attrib<3, SH_TEMP, Affine<double> , SH_PLANE>  Plane3a_d;
typedef Attrib<3, SH_CONST, Affine<double> , SH_PLANE> ConstPlane3a_d;
typedef Attrib<4, SH_INPUT, Affine<double> , SH_PLANE> InputPlane4a_d;
typedef Attrib<4, SH_OUTPUT, Affine<double> , SH_PLANE> OutputPlane4a_d;
typedef Attrib<4, SH_INOUT, Affine<double> , SH_PLANE> InOutPlane4a_d;
typedef Attrib<4, SH_TEMP, Affine<double> , SH_PLANE>  Plane4a_d;
typedef Attrib<4, SH_CONST, Affine<double> , SH_PLANE> ConstPlane4a_d;


typedef Attrib<1, SH_INPUT, Interval<float> , SH_PLANE> InputPlane1i_f;
typedef Attrib<1, SH_OUTPUT, Interval<float> , SH_PLANE> OutputPlane1i_f;
typedef Attrib<1, SH_INOUT, Interval<float> , SH_PLANE> InOutPlane1i_f;
typedef Attrib<1, SH_TEMP, Interval<float> , SH_PLANE>  Plane1i_f;
typedef Attrib<1, SH_CONST, Interval<float> , SH_PLANE> ConstPlane1i_f;
typedef Attrib<2, SH_INPUT, Interval<float> , SH_PLANE> InputPlane2i_f;
typedef Attrib<2, SH_OUTPUT, Interval<float> , SH_PLANE> OutputPlane2i_f;
typedef Attrib<2, SH_INOUT, Interval<float> , SH_PLANE> InOutPlane2i_f;
typedef Attrib<2, SH_TEMP, Interval<float> , SH_PLANE>  Plane2i_f;
typedef Attrib<2, SH_CONST, Interval<float> , SH_PLANE> ConstPlane2i_f;
typedef Attrib<3, SH_INPUT, Interval<float> , SH_PLANE> InputPlane3i_f;
typedef Attrib<3, SH_OUTPUT, Interval<float> , SH_PLANE> OutputPlane3i_f;
typedef Attrib<3, SH_INOUT, Interval<float> , SH_PLANE> InOutPlane3i_f;
typedef Attrib<3, SH_TEMP, Interval<float> , SH_PLANE>  Plane3i_f;
typedef Attrib<3, SH_CONST, Interval<float> , SH_PLANE> ConstPlane3i_f;
typedef Attrib<4, SH_INPUT, Interval<float> , SH_PLANE> InputPlane4i_f;
typedef Attrib<4, SH_OUTPUT, Interval<float> , SH_PLANE> OutputPlane4i_f;
typedef Attrib<4, SH_INOUT, Interval<float> , SH_PLANE> InOutPlane4i_f;
typedef Attrib<4, SH_TEMP, Interval<float> , SH_PLANE>  Plane4i_f;
typedef Attrib<4, SH_CONST, Interval<float> , SH_PLANE> ConstPlane4i_f;
