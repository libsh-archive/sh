...
void shCOND(Variable& dest, const Variable& cond,
            const Variable& a, const Variable& b);
SH_DLLEXPORT
void shLO(Variable& dest, const Variable& a);

SH_DLLEXPORT
void shHI(Variable& dest, const Variable& a);

SH_DLLEXPORT
void shWIDTH(Variable& dest, const Variable& a);

SH_DLLEXPORT
void shRADIUS(Variable& dest, const Variable& a);

SH_DLLEXPORT
void shCENTER(Variable& dest, const Variable& a);

SH_DLLEXPORT
void shIVAL(Variable& dest, const Variable& a, const Variable& b);

SH_DLLEXPORT
void shUNION(Variable& dest, const Variable& a, const Variable& b);

SH_DLLEXPORT
void shISCT(Variable& dest, const Variable& a, const Variable& b);

SH_DLLEXPORT
void shCONTAINS(Variable& dest, const Variable& a, const Variable& b);
