...
template<int N2>
Attrib<N2, Binding, T, Semantic, true>
Attrib<N, Binding, T, Semantic, Swizzled>::swiz(const Swizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return Attrib<N2, Binding, T, Semantic, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
Attrib<N2, Binding, T, Semantic, true>
Attrib<1, Binding, T, Semantic, Swizzled>::swiz(const Swizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return Attrib<N2, Binding, T, Semantic, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
Attrib<N2, Binding, T, Semantic, true>
Attrib<2, Binding, T, Semantic, Swizzled>::swiz(const Swizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return Attrib<N2, Binding, T, Semantic, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
Attrib<N2, Binding, T, Semantic, true>
Attrib<3, Binding, T, Semantic, Swizzled>::swiz(const Swizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return Attrib<N2, Binding, T, Semantic, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
Attrib<N2, Binding, T, Semantic, true>
Attrib<4, Binding, T, Semantic, Swizzled>::swiz(const Swizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return Attrib<N2, Binding, T, Semantic, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
