...
//STORAGETYPE_NAME_SPEC_DEF(Interval<Half>, "i_h");
STORAGETYPE_NAME_SPEC_DEF(Interval<float>, "i_f");
STORAGETYPE_NAME_SPEC_DEF(Interval<double>, "i_d");

//STORAGETYPE_NAME_SPEC_DEF(Affine<Half>, "a_h");
STORAGETYPE_NAME_SPEC_DEF(Affine<float>, "a_f");
STORAGETYPE_NAME_SPEC_DEF(Affine<double>, "a_d");
