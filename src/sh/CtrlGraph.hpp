...
public:
  ...
  CtrlGraph* owner() { return m_owner; }
  ...
  // mutable.
  void mark() const { m_marked = true; }         ///< Set the marked flag

  void unmark() const { m_marked = false; }      ///< Unset the marked flag
...
public:
  ...
  /// Clears marks on all owned nodes  
