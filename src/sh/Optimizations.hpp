...
/* Optimize also collects variables and decls.  All programs built with SH_BEGIN, SH_END are optimized
 * (possibly with no transformation at optimization level = 0),
 * to ensure decls/vars are properly collected */ 
