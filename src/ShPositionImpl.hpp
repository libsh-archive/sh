...
template<int N2>
ShPosition<N2, Binding, T, true>
ShPosition<N, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPosition<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPosition<N2, Binding, T, true>
ShPosition<1, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPosition<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPosition<N2, Binding, T, true>
ShPosition<2, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPosition<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPosition<N2, Binding, T, true>
ShPosition<3, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPosition<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
...
template<int N2>
ShPosition<N2, Binding, T, true>
ShPosition<4, Binding, T, Swizzled>::swiz(const ShSwizzle& s) const
{
  SH_DEBUG_ASSERT(s.size() == N2);
  return ShPosition<N2, Binding, T, true>(this->m_node, this->m_swizzle * s,this->m_neg);
}
