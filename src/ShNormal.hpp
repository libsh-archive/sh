...
typedef ShAttrib<1, SH_INPUT, ShInterval<double> , SH_NORMAL> ShInputNormal1i_d;
typedef ShAttrib<1, SH_OUTPUT, ShInterval<double> , SH_NORMAL> ShOutputNormal1i_d;
typedef ShAttrib<1, SH_INOUT, ShInterval<double> , SH_NORMAL> ShInOutNormal1i_d;
typedef ShAttrib<1, SH_TEMP, ShInterval<double> , SH_NORMAL> ShNormal1i_d;
typedef ShAttrib<1, SH_CONST, ShInterval<double> , SH_NORMAL> ShConstNormal1i_d;
typedef ShAttrib<2, SH_INPUT, ShInterval<double> , SH_NORMAL> ShInputNormal2i_d;
typedef ShAttrib<2, SH_OUTPUT, ShInterval<double> , SH_NORMAL> ShOutputNormal2i_d;
typedef ShAttrib<2, SH_INOUT, ShInterval<double> , SH_NORMAL> ShInOutNormal2i_d;
typedef ShAttrib<2, SH_TEMP, ShInterval<double> , SH_NORMAL> ShNormal2i_d;
typedef ShAttrib<2, SH_CONST, ShInterval<double> , SH_NORMAL> ShConstNormal2i_d;
typedef ShAttrib<3, SH_INPUT, ShInterval<double> , SH_NORMAL> ShInputNormal3i_d;
typedef ShAttrib<3, SH_OUTPUT, ShInterval<double> , SH_NORMAL> ShOutputNormal3i_d;
typedef ShAttrib<3, SH_INOUT, ShInterval<double> , SH_NORMAL> ShInOutNormal3i_d;
typedef ShAttrib<3, SH_TEMP, ShInterval<double> , SH_NORMAL> ShNormal3i_d;
typedef ShAttrib<3, SH_CONST, ShInterval<double> , SH_NORMAL> ShConstNormal3i_d;
typedef ShAttrib<4, SH_INPUT, ShInterval<double> , SH_NORMAL> ShInputNormal4i_d;
typedef ShAttrib<4, SH_OUTPUT, ShInterval<double> , SH_NORMAL> ShOutputNormal4i_d;
typedef ShAttrib<4, SH_INOUT, ShInterval<double> , SH_NORMAL> ShInOutNormal4i_d;
typedef ShAttrib<4, SH_TEMP, ShInterval<double> , SH_NORMAL> ShNormal4i_d;
typedef ShAttrib<4, SH_CONST, ShInterval<double> , SH_NORMAL> ShConstNormal4i_d;
...
typedef ShAttrib<1, SH_INPUT, ShAffine<double> , SH_NORMAL> ShInputNormal1a_d;
typedef ShAttrib<1, SH_OUTPUT, ShAffine<double> , SH_NORMAL> ShOutputNormal1a_d;
typedef ShAttrib<1, SH_INOUT, ShAffine<double> , SH_NORMAL> ShInOutNormal1a_d;
typedef ShAttrib<1, SH_TEMP, ShAffine<double> , SH_NORMAL> ShNormal1a_d;
typedef ShAttrib<1, SH_CONST, ShAffine<double> , SH_NORMAL> ShConstNormal1a_d;
typedef ShAttrib<2, SH_INPUT, ShAffine<double> , SH_NORMAL> ShInputNormal2a_d;
typedef ShAttrib<2, SH_OUTPUT, ShAffine<double> , SH_NORMAL> ShOutputNormal2a_d;
typedef ShAttrib<2, SH_INOUT, ShAffine<double> , SH_NORMAL> ShInOutNormal2a_d;
typedef ShAttrib<2, SH_TEMP, ShAffine<double> , SH_NORMAL> ShNormal2a_d;
typedef ShAttrib<2, SH_CONST, ShAffine<double> , SH_NORMAL> ShConstNormal2a_d;
typedef ShAttrib<3, SH_INPUT, ShAffine<double> , SH_NORMAL> ShInputNormal3a_d;
typedef ShAttrib<3, SH_OUTPUT, ShAffine<double> , SH_NORMAL> ShOutputNormal3a_d;
typedef ShAttrib<3, SH_INOUT, ShAffine<double> , SH_NORMAL> ShInOutNormal3a_d;
typedef ShAttrib<3, SH_TEMP, ShAffine<double> , SH_NORMAL> ShNormal3a_d;
typedef ShAttrib<3, SH_CONST, ShAffine<double> , SH_NORMAL> ShConstNormal3a_d;
typedef ShAttrib<4, SH_INPUT, ShAffine<double> , SH_NORMAL> ShInputNormal4a_d;
typedef ShAttrib<4, SH_OUTPUT, ShAffine<double> , SH_NORMAL> ShOutputNormal4a_d;
typedef ShAttrib<4, SH_INOUT, ShAffine<double> , SH_NORMAL> ShInOutNormal4a_d;
typedef ShAttrib<4, SH_TEMP, ShAffine<double> , SH_NORMAL> ShNormal4a_d;
typedef ShAttrib<4, SH_CONST, ShAffine<double> , SH_NORMAL> ShConstNormal4a_d;


typedef ShAttrib<1, SH_INPUT, ShAffine<float> , SH_NORMAL> ShInputNormal1a_f;
typedef ShAttrib<1, SH_OUTPUT, ShAffine<float> , SH_NORMAL> ShOutputNormal1a_f;
typedef ShAttrib<1, SH_INOUT, ShAffine<float> , SH_NORMAL> ShInOutNormal1a_f;
typedef ShAttrib<1, SH_TEMP, ShAffine<float> , SH_NORMAL> ShNormal1a_f;
typedef ShAttrib<1, SH_CONST, ShAffine<float> , SH_NORMAL> ShConstNormal1a_f;
typedef ShAttrib<2, SH_INPUT, ShAffine<float> , SH_NORMAL> ShInputNormal2a_f;
typedef ShAttrib<2, SH_OUTPUT, ShAffine<float> , SH_NORMAL> ShOutputNormal2a_f;
typedef ShAttrib<2, SH_INOUT, ShAffine<float> , SH_NORMAL> ShInOutNormal2a_f;
typedef ShAttrib<2, SH_TEMP, ShAffine<float> , SH_NORMAL> ShNormal2a_f;
typedef ShAttrib<2, SH_CONST, ShAffine<float> , SH_NORMAL> ShConstNormal2a_f;
typedef ShAttrib<3, SH_INPUT, ShAffine<float> , SH_NORMAL> ShInputNormal3a_f;
typedef ShAttrib<3, SH_OUTPUT, ShAffine<float> , SH_NORMAL> ShOutputNormal3a_f;
typedef ShAttrib<3, SH_INOUT, ShAffine<float> , SH_NORMAL> ShInOutNormal3a_f;
typedef ShAttrib<3, SH_TEMP, ShAffine<float> , SH_NORMAL> ShNormal3a_f;
typedef ShAttrib<3, SH_CONST, ShAffine<float> , SH_NORMAL> ShConstNormal3a_f;
typedef ShAttrib<4, SH_INPUT, ShAffine<float> , SH_NORMAL> ShInputNormal4a_f;
typedef ShAttrib<4, SH_OUTPUT, ShAffine<float> , SH_NORMAL> ShOutputNormal4a_f;
typedef ShAttrib<4, SH_INOUT, ShAffine<float> , SH_NORMAL> ShInOutNormal4a_f;
typedef ShAttrib<4, SH_TEMP, ShAffine<float> , SH_NORMAL> ShNormal4a_f;
typedef ShAttrib<4, SH_CONST, ShAffine<float> , SH_NORMAL> ShConstNormal4a_f;
...
typedef ShAttrib<1, SH_INPUT, ShInterval<float> , SH_NORMAL> ShInputNormal1i_f;
typedef ShAttrib<1, SH_OUTPUT, ShInterval<float> , SH_NORMAL> ShOutputNormal1i_f;
typedef ShAttrib<1, SH_INOUT, ShInterval<float> , SH_NORMAL> ShInOutNormal1i_f;
typedef ShAttrib<1, SH_TEMP, ShInterval<float> , SH_NORMAL> ShNormal1i_f;
typedef ShAttrib<1, SH_CONST, ShInterval<float> , SH_NORMAL> ShConstNormal1i_f;
typedef ShAttrib<2, SH_INPUT, ShInterval<float> , SH_NORMAL> ShInputNormal2i_f;
typedef ShAttrib<2, SH_OUTPUT, ShInterval<float> , SH_NORMAL> ShOutputNormal2i_f;
typedef ShAttrib<2, SH_INOUT, ShInterval<float> , SH_NORMAL> ShInOutNormal2i_f;
typedef ShAttrib<2, SH_TEMP, ShInterval<float> , SH_NORMAL> ShNormal2i_f;
typedef ShAttrib<2, SH_CONST, ShInterval<float> , SH_NORMAL> ShConstNormal2i_f;
typedef ShAttrib<3, SH_INPUT, ShInterval<float> , SH_NORMAL> ShInputNormal3i_f;
typedef ShAttrib<3, SH_OUTPUT, ShInterval<float> , SH_NORMAL> ShOutputNormal3i_f;
typedef ShAttrib<3, SH_INOUT, ShInterval<float> , SH_NORMAL> ShInOutNormal3i_f;
typedef ShAttrib<3, SH_TEMP, ShInterval<float> , SH_NORMAL> ShNormal3i_f;
typedef ShAttrib<3, SH_CONST, ShInterval<float> , SH_NORMAL> ShConstNormal3i_f;
typedef ShAttrib<4, SH_INPUT, ShInterval<float> , SH_NORMAL> ShInputNormal4i_f;
typedef ShAttrib<4, SH_OUTPUT, ShInterval<float> , SH_NORMAL> ShOutputNormal4i_f;
typedef ShAttrib<4, SH_INOUT, ShInterval<float> , SH_NORMAL> ShInOutNormal4i_f;
typedef ShAttrib<4, SH_TEMP, ShInterval<float> , SH_NORMAL> ShNormal4i_f;
typedef ShAttrib<4, SH_CONST, ShInterval<float> , SH_NORMAL> ShConstNormal4i_f;
