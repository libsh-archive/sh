...
extern "C" {
  ...
  // A few defines to make stuff happy on Linux
#define APIENTRY
#define INT_PTR int *
#define HANDLE int
...
typedef GLvoid (APIENTRY * PFNGLFOGCOORDPOINTERPROC) (GLenum type, GLsizei stride, GLvoid *pointer);

/*
**  G.6 Multiple Draw Arrays
*/
typedef GLvoid (APIENTRY * PFNGLMULTIDRAWARRAYSPROC) (GLenum mode, GLint *first, GLsizei *count, GLsizei primcount);
typedef GLvoid (APIENTRY * PFNGLMULTIDRAWELEMENTSPROC) (GLenum mode, GLsizei *count, GLenum type, const GLvoid **indices, GLsizei primcount);
...
typedef GLvoid (APIENTRY * PFNGLPOINTPARAMETERFVPROC)  (GLenum pname, GLfloat *params);
typedef GLvoid (APIENTRY * PFNGLPOINTPARAMETERIPROC)  (GLenum pname, GLint param);
typedef GLvoid (APIENTRY * PFNGLPOINTPARAMETERIVPROC)  (GLenum pname, GLint *params);
...
typedef GLvoid (APIENTRY * PFNGLSECONDARYCOLORPOINTERPROC)(GLint size, GLenum type, GLsizei stride, GLvoid *pointer);
...
*/
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2DPROC) (double x, double y);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2FPROC) (float x, float y);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2IPROC) (int x, int y);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2SPROC) (short x, short y);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2IVPROC) (const int *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2SVPROC) (const short *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2FVPROC) (const float *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS2DVPROC) (const double *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3IPROC) (int x, int y, int z);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3SPROC) (short x, short y, short z);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3FPROC) (float x, float y, float z);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3DPROC) (double x, double y, double z);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3IVPROC) (const int *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3SVPROC) (const short *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3FVPROC) (const float *p);
typedef GLvoid (APIENTRY * PFNGLWINDOWPOS3DVPROC) (const double *p);
...
#ifdef FGL_LINUX
// that defines are not yet needed (implicit enum definitions wont work anyways for GNUC)
#else
...
#define GL_CMM_TOTAL_BYTES_AGP          0x00400101  // TEMPORARY VALUE
...
#define GL_PROGRAM_OBJECT_GL2           0x8B40

#define GL_UNIFORM_ERROR_CHECK_GL2      0x8B48

#define GL_SHADER_OBJECT_GL2            0x8B80

#define GL_FLOAT_VEC2_GL2               0x8B50
#define GL_FLOAT_VEC3_GL2               0x8B51
#define GL_FLOAT_VEC4_GL2               0x8B52
#define GL_INT_VEC2_GL2                 0x8B53
#define GL_INT_VEC3_GL2                 0x8B54
#define GL_INT_VEC4_GL2                 0x8B55
#define GL_BOOL_GL2                     0x8B56
#define GL_BOOL_VEC2_GL2                0x8B57
#define GL_BOOL_VEC3_GL2                0x8B58
#define GL_BOOL_VEC4_GL2                0x8B59
#define GL_FLOAT_MAT2_GL2               0x8B5A
#define GL_FLOAT_MAT3_GL2               0x8B5B
#define GL_FLOAT_MAT4_GL2               0x8B5C
...
typedef GLvoid              (APIENTRY *PFNGLSHADERSOURCEGL2PROC)(GLhandleGL2 shaderObj,
                                                                 GLsizei count,
                                                                 const GLcharGL2 **string,
                                                                 const GLint *length);
...
typedef GLvoid              (APIENTRY *PFNGLATTACHOBJECTGL2PROC)(GLhandleGL2 containerObj,
                                                                 GLhandleGL2 obj);
typedef GLboolean           (APIENTRY *PFNGLLINKPROGRAMGL2PROC)(GLhandleGL2 programObj);
typedef GLvoid              (APIENTRY *PFNGLUSEPROGRAMOBJECTGL2PROC)(GLhandleGL2 programObj);
typedef GLboolean           (APIENTRY *PFNGLVALIDATEPROGRAMGL2PROC)(GLhandleGL2 programObj);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT1FGL2PROC)(GLint location,
                                                                   GLfloat v0);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT2FGL2PROC)(GLint location,
                                                                   GLfloat v0,
                                                                   GLfloat v1);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT3FGL2PROC)(GLint location,
                                                                   GLfloat v0,
                                                                   GLfloat v1,
                                                                   GLfloat v2);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT4FGL2PROC)(GLint location,
                                                                   GLfloat v0,
                                                                   GLfloat v1,
                                                                   GLfloat v2,
                                                                   GLfloat v3);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT1IGL2PROC)(GLint location,
                                                                 GLint v0);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT2IGL2PROC)(GLint location,
                                                                 GLint v0,
                                                                 GLint v1);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT3IGL2PROC)(GLint location,
                                                                 GLint v0,
                                                                 GLint v1,
                                                                 GLint v2);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT4IGL2PROC)(GLint location,
                                                                 GLint v0,
                                                                 GLint v1,
                                                                 GLint v2,
                                                                 GLint v3);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL1IGL2PROC)(GLint location,
                                                                  GLboolean v0);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL2IGL2PROC)(GLint location,
                                                                  GLboolean v0,
                                                                  GLboolean v1);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL3IGL2PROC)(GLint location,
                                                                  GLboolean v0,
                                                                  GLboolean v1,
                                                                  GLboolean v2);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL4IGL2PROC)(GLint location,
                                                                  GLboolean v0,
                                                                  GLboolean v1,
                                                                  GLboolean v2,
                                                                  GLboolean v3);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT1FVGL2PROC)(GLint location,
                                                                    GLsizei count,
                                                                    GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT2FVGL2PROC)(GLint location,
                                                                    GLsizei count,
                                                                    GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT3FVGL2PROC)(GLint location,
                                                                    GLsizei count,
                                                                    GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOAT4FVGL2PROC)(GLint location,
                                                                    GLsizei count,
                                                                    GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT1IVGL2PROC)(GLint location,
                                                                  GLsizei count,
                                                                  GLint *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT2IVGL2PROC)(GLint location,
                                                                  GLsizei count,
                                                                  GLint *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT3IVGL2PROC)(GLint location,
                                                                  GLsizei count,
                                                                  GLint *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMINT4IVGL2PROC)(GLint location,
                                                                  GLsizei count,
                                                                  GLint *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL1IVGL2PROC)(GLint location,
                                                                   GLsizei count,
                                                                   GLboolean *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL2IVGL2PROC)(GLint location,
                                                                   GLsizei count,
                                                                   GLboolean *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL3IVGL2PROC)(GLint location,
                                                                   GLsizei count,
                                                                   GLboolean *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMBOOL4IVGL2PROC)(GLint location,
                                                                   GLsizei count,
                                                                   GLboolean *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOATMATRIX2FVGL2PROC)(GLint location,
                                                                          GLsizei count,
                                                                          GLboolean transpose,
                                                                          GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOATMATRIX3FVGL2PROC)(GLint location,
                                                                          GLsizei count,
                                                                          GLboolean transpose,
                                                                          GLfloat *value);
typedef GLvoid              (APIENTRY *PFNGLUNIFORMFLOATMATRIX4FVGL2PROC)(GLint location,
                                                                          GLsizei count,
                                                                          GLboolean transpose,
                                                                          GLfloat *value);
...
typedef const GLhandleGL2 * (APIENTRY *PFNGLGETATTACHEDOBJECTSGL2PROC)(GLhandleGL2 containerObj,
                                                                       GLint *length);
typedef GLint               (APIENTRY *PFNGLGETUNIFORMLOCATIONGL2PROC)(GLhandleGL2 programObj,
                                                                       const GLcharGL2 *name);
typedef GLvoid              (APIENTRY *PFNGLGETACTIVEUNIFORMSGL2PROC)(GLhandleGL2 programObj,
                                                                      GLint *count,
                                                                      const GLint **size,
                                                                      const GLenum **type,
                                                                      const GLcharGL2 * const **uniforms);
...
typedef GLvoid              (APIENTRY *PFNGLGETUNIFORMIVGL2PROC)(GLhandleGL2 programObj,
                                                                 GLint location,
                                                                 GLint *params);
typedef GLvoid              (APIENTRY *PFNGLGETSHADERSOURCEGL2PROC)(GLhandleGL2 obj,
                                                                    GLint *count,
                                                                    const GLcharGL2 * const **strings,
                                                                    const int **length);
...
#define GL_VERTEX_SHADER_GL2                        0x8B31

#define GL_MAX_VERTEX_UNIFORM_COMPONENTS_GL2        0x8B4A
#define GL_MAX_VARYING_FLOATS_GL2                   0x8B4B
#define GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS_GL2       0x8B4C
#define GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS_GL2     0x8B4D

#define GL_OBJECT_TYPE_GL2                          0x8B4E
#define GL_OBJECT_SUBTYPE_GL2                       0x8B4F

typedef GLvoid      (APIENTRY *PFNGLBINDATTRIBLOCATIONGL2PROC)(GLhandleGL2 programObj,
                                                               GLuint index,
                                                               const GLcharGL2 *name);
typedef GLvoid      (APIENTRY *PFNGLGETACTIVEATTRIBSGL2PROC)(GLhandleGL2 programObj,
                                                             GLint *count,
                                                             const GLint **size,
                                                             const GLenum **type,
                                                             const GLcharGL2 * const **attributes);
typedef GLint       (APIENTRY *PFNGLGETATTRIBLOCATIONGL2PROC)(GLhandleGL2 programObj,
                                                              const GLcharGL2 *name);
...
#define GL_FRAGMENT_SHADER_GL2                      0x8B30

#define GL_MAX_FRAGMENT_UNIFORM_COMPONENTS_GL2      0x8B49
